...
fn mint_ibc(
    ...
    let ibc_transfer_msg = CosmosMsg::Ibc(IbcMsg::Transfer {
        channel_id,
        to_address,
        amount: coin(amount, denom.clone()),
    ...
    Ok(Response::new()
        .add_attribute("method", "mint_and_ibc")
        .add_attribute("denom", denom)
        .add_messages([mint_msg, ibc_transfer_msg]))
}
